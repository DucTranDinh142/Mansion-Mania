...
public class UI_TreeConnectHandler : MonoBehaviour
{
    ...
    private Color originalConnectColor;

    private void Awake()
    {
        if (connectionImage != null)
            originalConnectColor = connectionImage.color;
    }
    ...
    private void UpdateConnections()
    {
        for (int i = 0; i < connectionDetails.Length; i++)
        {
            ...
            Vector2 targetPosition = connection.GetConnetionPoint(rect);
    ...
    public void UnlockedConnectionImage(bool unlocked)
    {
        ...
        connectionImage.color = unlocked ? Color.yellow : originalConnectColor;
    }
